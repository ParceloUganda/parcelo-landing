...
import { MessageCircle, FileText, Wand2, type LucideIcon } from 'lucide-react'

const STEPS: { step: string; Icon: LucideIcon; title: string; body: string; link?: boolean }[] = [
  {
    step: 'STEP 01',
    Icon: MessageCircle,
            ...
            return (
              ...
              >
                ...
                <div style={{
                  ...
                  <Icon size={20} strokeWidth={1.5} color="var(--gold)" />
                </div>
