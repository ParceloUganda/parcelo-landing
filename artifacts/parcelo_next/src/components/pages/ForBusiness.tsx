...
import { Lock, Truck, FileText, Headphones, Check } from 'lucide-react'

const BUSINESS_TYPES = [
  'Beauty', 'Health', 'Hospitality', 'Construction',
  'Agriculture', 'Auto', 'Fashion', 'Electronics',
]
      ...
      <section style={{ padding: '72px 24px 64px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '820px', margin: 'auto' }}>
          ...
          <div style={{
            ...
            {[
              { Icon: Check, label: 'Verified Suppliers' },
            ...
            {[
              ...
              >
                <div style={{
                  ...
                  <Icon size={22} strokeWidth={1.5} color="var(--gold)" />
                </div>
                <h3 style={{
                  fontSize: '17px',
                  fontWeight: 700,
